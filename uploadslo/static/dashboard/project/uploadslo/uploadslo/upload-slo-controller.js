...
(function () {
  ...
  angular
    ...
    .controller(
      'horizon.dashboard.project.uploadslo.uploadslo.UploadSloModalController',
      UploadSloModalController
    );

  UploadSloModalController.$inject = [
    'horizon.dashboard.project.containers.containers-model'
  ];

  function UploadSloModalController(model) {
    var ctrl = this;
